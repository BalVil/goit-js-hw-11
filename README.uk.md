...
1. Переконайся що на комп'ютері встановлено LTS-версію Node.js.
   [Скачай і встанови](https://nodejs.org/en/) її, якщо треба.
...
5. Відкрий проєкт у VSCode, запусти термінал і зсполучи проєкт із
   GitHub-репозиторієм
...
Статус деплою крайнего коммита отображается иконкой возле его идентификатора.
